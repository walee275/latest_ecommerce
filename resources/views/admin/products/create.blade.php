                    ...
                    @if ($errors->has('pictures.*'))
                        <div class="alert alert-danger">
                            @foreach ($errors->get('pictures.*') as $error)
                                @if (count($error))
                                <p class="text-danger">
                                    The product picture must be of file type of png,jpg,jpeg only
                                </p>
                                @endif
                                @endforeach
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="border border-3 p-4 rounded">
                                        ...
                                        <div class="mb-3">
                                            <label for="pictures" class="form-label">Product Images <sup>recommended picture size 1600 x 900  </sup></label>
                                                ...
                                                <select name="vendor" id="vendor" class="form-select">
                                                    ...
                                                    @forelse ($vendors as $vendor)
                                                        <option value="{{ $vendor->id }}"
                                                            {{ old('vendor') && old('vendor') == $vendor->id ? 'selected' : '' }}>
                                                            {{ $vendor->name }}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
        ...
        $(document).ready(function() {
            ...
            function updateSubcategories() {
                ...
                if (selectedCategoryId != '' && selectedCategoryId !== undefined) {
                    ...
                    $('#subcategory').html('<option value="">Select Product Category</option>');
            ...
            $('#add-size-btn').on('click', function(e) {
                ...
                const output = `<div class="form-group mb-3">
                                    <label for="size">Size ${sizesIteration}</label>
                                    <input type="text" class="form-control" name="sizes[]" id="size_${sizesIteration}">
                                    <button type="button" class="btn btn-danger btn-sm remove-size-field" id="add-size-btn${sizesIteration}">Remove Size</button>
                                </div>`;


                $('#sizes-inputs-container').append(output);
                sizesIteration++;


            });

            $(document).on('click', '.remove-size-field', function(e) {
                e.preventDefault();

                $(this).closest('.form-group').remove();
                sizesIteration = sizesIteration - 1;
            });
